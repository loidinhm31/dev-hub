...
import { EditorPlaceholder } from "@/components/organisms/EditorPlaceholder.js";
...
export default function IdePage() {
  ...
  const [openFile, setOpenFile] = useState<FsArborNode | null>(null);
  ...
  return (
    <IdeShell
      ...
      editor={<EditorPlaceholder openFile={openFile} />}
